...
def main(args):
    ...
    state_dict = find_model(r'E:\Programming\diffusion_transformer\dit_weights\003-DiT-S-2\checkpoints\0050005_10000.pt')

    #Имзенение весов в случае дообучения XL модели
    ...
    # state_dict['y_embedder.embedding_table.weight'] = torch.cat((t1, t2), 0)
